...
%o`, message, error2, detail);
  ...
  // app/javascript/controllers/apply_filter_controller.js
  var apply_filter_controller_default = class extends Controller {
    connect() {
    }
    applyFilter(e) {
  ...
  __publicField(apply_filter_controller_default, "targets", ["image", "hiddenImage", "filterButton", "filterName"]);
  ...
  // app/javascript/controllers/new_post_form_controller.js
  var new_post_form_controller_default = class extends Controller {
    connect() {
    }
    selectFile(e) {
      e.preventDefault();
  ...
  __publicField(new_post_form_controller_default, "targets", ["selectFileButton", "photoFile"]);

  // app/javascript/controllers/photo_cropper_controller.js
  var import_cropperjs = __toESM(require_cropper());
  var photo_cropper_controller_default = class extends Controller {
    connect() {
      const controller = this;
      new import_cropperjs.default(this.imageTarget, {
        aspectRatio: 1 / 1,
        crop(event) {
  ...
  __publicField(photo_cropper_controller_default, "targets", ["image", "form", "xOffset", "yOffset", "width", "height"]);

  // app/javascript/controllers/photo_filter_controller.js
  var photo_filter_controller_default = class extends Controller {
    connect() {
      this.element.onload = () => {
  ...
  __publicField(photo_filter_controller_default, "targets", ["image"]);

  // app/javascript/controllers/index.js
  application.register("apply-filter", apply_filter_controller_default);
  application.register("hello", hello_controller_default);
  application.register("new-post-form", new_post_form_controller_default);
  application.register("photo-cropper", photo_cropper_controller_default);
  application.register("photo-filter", photo_filter_controller_default);
